...
export const skillsData: SkillsData = {
  ...
  categories: {
    ...
    "CMS & Platforms": [
      ...
      { name: "Contentstack", iconUrl: "/images/icons/contentstack-icon-unplated-128.webp", level: 0 },
    ...
    "DevOps & Infrastructure": [
      ...
      { name: "Zabbix", iconUrl: "https://upload.wikimedia.org/wikipedia/commons/5/5d/Zabbix_logo_square.svg", level: 0 },
      { name: "Bacula", iconUrl: "https://www.bacula.org/wp-content/uploads/2018/10/logo_bacula11.png", level: 0 }
    ],
    ...
    "Development Tools": [
      ...
      { name: "phpMyAdmin", iconUrl: "https://www.ampps.com/sitepad-data/uploads/2023/03/phpmyadmin.png", level: 0 }
    ],
    "Network & Security": [
      ...
      { name: "phpIPAM", iconUrl: "https://phpipam.net/css/images/phpipam_logo_small@2x.png", level: 0 }
    ],
    "Operating Systems": [
