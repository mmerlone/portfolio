...
* **globe:**  improve TypeScript types and remove any usage
  - Add proper interfaces for GlobeMaterial and ArcData
  - Remove any type assertions and replace with proper types
  - Fix groupRef type to match its usage
  - Add missing dependencies to useEffect hook
