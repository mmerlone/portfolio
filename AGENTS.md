...
- `src/data/**` and `public/**` are ignored by knip. **No data or asset may be removed.**
- Keep data files stale; do not delete or prune them.
- Move unused assets to `public/archive/` instead of deleting.
